<?php
$api_base_url = "https://api.stage.sheba.xyz";
$business_base_url = "https://business.stage.sheba.xyz";
...
function makePage($tender, $title, $page_url)
{
    ...
    $html .= '<meta property="og:image" content="https://cdn-shebaxyz.s3.ap-south-1.amazonaws.com/sheba_xyz/images/default_og_image.jpg"/>' . PHP_EOL;
