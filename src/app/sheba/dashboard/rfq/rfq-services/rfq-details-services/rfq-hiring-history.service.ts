...
export class RfqHiringHistoryService {
  ...
  constructor(private http: ShebaHttpService,
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<any> {
        return this.getHiringHistory(route.parent.params.id);
    }

    getHiringHistory(rfqId: number) {
        const url = `v2/businesses/${this.storage.user.business_id}/procurements/${rfqId}/hiring-history`;
